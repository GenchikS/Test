...
// textarea.value = localStorage.getItem(localStorageKeyUser) ?? "";  //  присвоєння textarea.value значення ключа відразу (синхронно), якщо такого ключа немає, то вважати що він пустий ("")

// form.addEventListener("input", (evt) => {
//   localStorage.setItem(localStorageKeyUser, evt.target.value);  //  додавання значення ключа в LS
// });
