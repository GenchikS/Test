...
const catsAll = document.querySelector(`.container`)
console.log(`cats`, catsAll);

варіант 
// const userCats = cats.map(cat =>
//     console.log(`cat`, cat)
// );

function userCats(event) {
    const userCatAll = cats.map(cat => cat)
    console.log(userCatAll)
}

userCats(cats);

// catsAll.insertAdjacentHTML(`afterbegin`, )
